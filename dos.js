...
function newWorkout() {
    ...
    document.getElementById('workoutDisplay').innerHTML = exercises[randomNumber1] + '/n' + exercises[randomNumber2] + "  ,  " + exercises[randomNumber3] + "  ,  " +  exercises[randomNumber4] + "  ,  " +  exercises[randomNumber5] + "  ,  " +  exercises[randomNumber6] + "  ,  " +  exercises[randomNumber7] + "  ,  " +  exercises[randomNumber8] + "  ,  " +  exercises[randomNumber9] + "  ,  " +  exercises[randomNumber10];
